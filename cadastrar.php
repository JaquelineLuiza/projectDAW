            ...
            <form method="POST" action="insere.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                        placeholder="seu nome completo" required="required" name="nome">
                </div>
                <div class="form-group">
                ...
                <label class="custom-control-label" for="customRadioDisabled2">Usuário administrador</label>
                </div>

                <div class="form-check">
                <input class="form-check-input" type="radio" name="nivel" id="id_nivel" value="2">
                <label class="form-check-label" for="id_nivel">
                    Usuário comum
                </label>
                </div>
